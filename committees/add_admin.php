...
// Check if this user is committee admin for THIS committee
              ...
              <tbody>
                <?php $i = 1; foreach ($members as $m): ?>
                  <tr>
                    <td><?= $i++ ?></td>
                    <td>
                      <div class="fw-semibold"><?= htmlspecialchars($m['full_name'] ?? 'Unknown') ?></div>
      ...
      <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
        ...
        <?php if ($isSuper): ?>
          <span class="badge bg-info-subtle text-info-emphasis small">
            Superadmin can promote heads in <code>Manage Committee Heads</code>.
          </span>
        <?php endif; ?>
      </div>
      <div class="card-body">
        <?php if (!$canManageMembers): ?>
          <div class="alert alert-warning small mb-0">
            ...
            Please contact a committee admin or system administrator.
          </div>
        <?php else: ?>
          <form method="post" action="/mms/committees/add_member.php" class="row g-2">
            ...
            <div class="col-12">
              <div class="alert alert-info py-2 small mb-2">
                This form adds <strong>members</strong> only.
                Committee heads (admins) can be assigned by superadmin from the
                <em>Manage Committee Heads</em> section.
              </div>
            </div>
